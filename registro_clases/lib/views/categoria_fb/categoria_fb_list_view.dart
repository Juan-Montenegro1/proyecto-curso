            ...
            return Center(
              child: Column(
                ...
                children: [
                  ...
                  const SizedBox(height: 8),
                  Text(
                    'Toca el botón + para crear una universidad',
                    style: TextStyle(
        ...
        Expanded(
          child: Column(
            ...
            children: [
              ...
              // Mostrar NIT y teléfono si existen
              if (categoria.nit.isNotEmpty || categoria.telefono.isNotEmpty)
                Text(
                  '${categoria.nit.isNotEmpty ? 'NIT: ${categoria.nit}' : ''}${categoria.nit.isNotEmpty && categoria.telefono.isNotEmpty ? ' • ' : ''}${categoria.telefono.isNotEmpty ? 'Tel: ${categoria.telefono}' : ''}',
                  style: TextStyle(
                    fontSize: 12,
                    color: colorScheme.onSurfaceVariant,
                  ),
    ...
    if (confirmar == true && context.mounted) {
      try {
        ...
        if (context.mounted) {
          ScaffoldMessenger.of(context).showSnackBar(
            SnackBar(
              content: Text('Universidad "${categoria.nombre}" eliminada'),
